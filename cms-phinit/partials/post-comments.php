...
$commentTextValue = phinit_input_string($_POST, 'comment', phinit_input_string($_POST, 'comment_text', '', 5000), 5000);
$commentNameValue = phinit_input_string($_POST, 'author', phinit_input_string($_POST, 'comment_name', '', 120), 120);
$commentEmailValue = phinit_input_string($_POST, 'email', phinit_input_string($_POST, 'comment_email', '', 254), 254);
