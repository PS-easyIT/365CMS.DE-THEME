...
$_repoWrapSection = !isset($_repoWrapSection) || filter_var($_repoWrapSection, FILTER_VALIDATE_BOOLEAN);
$_repoCardClass = 'repo-card'
    . (!empty($_repoInInfoGrid) ? ' repo-card--info-lead' : '')
    . (!empty($_repoFooterBanner) ? ' repo-card--footer' : '');
?>
<?php if ($_repoWrapSection): ?>
<section class="content-section home-section home-section--repo">
<?php endif; ?>
    <div class="<?php echo htmlspecialchars($_repoCardClass, ENT_QUOTES); ?>">
