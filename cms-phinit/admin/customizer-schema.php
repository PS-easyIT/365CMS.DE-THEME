...
return [
    ...
    'config' => [
        ...
        'menus' => [
            ...
            'sections' => [
                'primary_menu_items' => [
                    'label' => 'Hauptnavigation / Main navigation',
                    'type' => 'menu_tree',
                    'default' => '',
                    'rows' => 10,
                    'description' => 'Format je Zeile: Label | URL. Unterpunkte per 2 Leerzeichen einrücken. / One line per item: Label | URL. Indent children with 2 spaces.',
                ],
                ...
                'footer_topics_menu_items' => [
                    'label' => 'Footer Themen / Footer topics',
                    'type' => 'menu_tree',
                    'default' => '',
                    'rows' => 8,
                    'description' => 'Format je Zeile: Label | URL. Unterpunkte per 2 Leerzeichen einrücken. / One line per item: Label | URL. Indent children with 2 spaces.',
                ...
                'footer_pages_menu_items' => [
                    'label' => 'Footer Seiten / Footer pages',
                    'type' => 'menu_tree',
                    'default' => '',
                    'rows' => 8,
                    'description' => 'Format je Zeile: Label | URL. Unterpunkte per 2 Leerzeichen einrücken. / One line per item: Label | URL. Indent children with 2 spaces.',
                ...
                'footer_legal_menu_items' => [
                    'label' => 'Footer Rechtliches / Footer legal',
                    'type' => 'menu_tree',
                    'default' => '',
                    'rows' => 8,
                    'description' => 'Format je Zeile: Label | URL. Unterpunkte per 2 Leerzeichen einrücken. / One line per item: Label | URL. Indent children with 2 spaces.',
        ...
        'header' => [
            ...
            'sections' => [
                ...
                'show_consulting_nav_item'  => ['label' => 'M365 Consulting Menüpunkt anzeigen', 'type' => 'checkbox', 'default' => false, 'description' => 'Zeigt einen rechts angepinnten CTA-Menüpunkt in der Hauptnavigation. Standardmäßig ausgeblendet.'],
                'consulting_nav_label'      => ['label' => 'M365 Consulting Menüpunkt Label', 'type' => 'text', 'default' => 'M365 CONSULTING'],
                'consulting_nav_url'        => ['label' => 'M365 Consulting Ziel / Slug', 'type' => 'url', 'default' => 'microsoft-365-und-copilot-beratung', 'description' => 'Akzeptiert einen reinen Landingpage-Slug (wird zu /beratung/{slug}), einen relativen Pfad oder eine vollständige URL.'],
        ...
        'homepage' => [
            ...
            'sections' => [
                ...
                'show_meta_author'           => ['label' => 'Meta: Autor',                  'type' => 'checkbox', 'default' => false],
                ...
                'show_tile_author'           => ['label' => 'Grid: Autor anzeigen',         'type' => 'checkbox', 'default' => false],
    ...
    'tabViews' => [
        ...
        'homepage-list' => [
            ...
            'fields' => [
                ...
                ['tab' => 'homepage', 'key' => 'show_meta_author'],
            ...
            'groups' => [
                ...
                '✍️ Text & Metadaten' => ['show_article_excerpt','show_article_meta','show_meta_category','show_meta_author','show_meta_date','show_meta_readtime'],
            ],
        ],
        'homepage-sidebar' => [
        ...
        'homepage-grid-feeds' => [
            ...
            'fields' => [
                ...
                ['tab' => 'homepage', 'key' => 'show_tile_author'],
            ...
            'groups' => [
                '🧱 Kachel-Grid' => ['show_tile_grid','tile_grid_label','tile_grid_count','tile_grid_columns','show_tile_excerpt','show_tile_category','show_tile_author','show_tile_date','tile_grid_image_height','tile_grid_link_url'],
    ...
    'navGroups' => [
        null        => ['language', 'layout', 'header', 'menus', 'homepage-sidebar', 'footer'],
