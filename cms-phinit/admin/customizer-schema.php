...
return [
    ...
    'config' => [
        'colors' => [
            ...
            'sections' => [
                ...
                'text_nav_footer_bottom_hover' => ['label' => 'Footer-Bottom Hover Text', 'type' => 'color', 'default' => 'rgba(255,255,255,.75)'],
    ...
    'tabViews' => [
        'homepage-layout' => [
            ...
            'groups' => [
                '👁️ Sichtbarkeit der Sektionen' => ['show_repo_card','show_article_list','show_list_sidebar','show_info_cards','show_info_card3','show_tile_grid','show_feed_section'],
        ...
        'homepage-sidebar' => [
            ...
            'groups' => [
                '📋 Grundlayout' => ['show_list_sidebar','list_sidebar_width','list_sidebar_title','list_sidebar_content'],
