...
return [
    ...
    'config' => [
        ...
        'pages' => [
            ...
            'sections' => [
                ...
                'show_page_author_box'   => ['label' => 'Autorenbox auf Seiten anzeigen',  'type' => 'checkbox', 'default' => true],
                'page_author_eyebrow'    => ['label' => 'Seiten-Autorenbox Kicker',        'type' => 'text',     'default' => 'Autor'],
                'page_author_name'       => ['label' => 'Seiten-Autor Name',               'type' => 'text',     'default' => 'Andreas Hepp'],
                'page_author_about_label'=> ['label' => 'Seiten-Autor Über-mich Label',    'type' => 'text',     'default' => 'Über mich'],
                'page_author_about_width'=> ['label' => 'Seiten-Autorbereich Breite (%)',  'type' => 'number',   'default' => '60', 'min' => 50, 'max' => 75, 'step' => 5, 'allowed_values' => [50, 60, 75], 'description' => 'Erlaubte Werte: 50, 60 oder 75. Der Dienstleistungsbereich nutzt automatisch den Rest.'],
                'page_author_bio'        => ['label' => 'Seiten-Autor Bio',                'type' => 'textarea', 'default' => 'IT-Administrator, Blogger und PowerShell-Enthusiast. Ich unterstütze Unternehmen bei Microsoft 365, 365CMS und moderner IT-Automatisierung.'],
                'page_author_avatar_url' => ['label' => 'Seiten-Autor Avatar-URL',         'type' => 'url',      'default' => ''],
                'show_page_author_service_hub' => ['label' => 'Dienstleistungs-HubSite anzeigen', 'type' => 'checkbox', 'default' => true],
                'page_author_service_hub_url' => ['label' => 'Dienstleistungs-HubSite URL', 'type' => 'url',      'default' => '/it-dienstleistungen'],
                'page_author_service_hub_label' => ['label' => 'Dienstleistungs-Link Text', 'type' => 'text',     'default' => 'Dienstleistungen ansehen'],
                'page_author_service_hub_text' => ['label' => 'Dienstleistungs-Hinweistext', 'type' => 'textarea', 'default' => 'Passend zu dieser Seite findest du hier Dienstleistungen, Beratungspakete und konkrete Unterstützung für deine IT- oder 365CMS-Projekte.'],
            ],
        ],
        'social' => [
            'title' => '🌐 Social Media',
    ...
    'tabGroups' => [
        ...
        'pages'      => ['📄 Seiteneinstellungen' => ['show_page_title','page_title_fontsize','show_page_hero','page_hero_width','page_hero_height','page_hero_fit_mode','show_page_updated_date','page_layout','show_page_sidebar','page_sidebar_show_nav','show_page_toc'], '👤 Autorenbox & Dienstleistungen' => ['show_page_author_box','page_author_eyebrow','page_author_name','page_author_about_label','page_author_about_width','page_author_bio','page_author_avatar_url','show_page_author_service_hub','page_author_service_hub_url','page_author_service_hub_label','page_author_service_hub_text']],
